                ...
                <div className="flex flex-col lg:flex-row gap-0 lg:gap-24 items-center justify-center lg:justify-start lg:items-end w-full max-w-full overflow-x-hidden">
                    ...
                    >
                        ...
                        <div className="flex flex-row items-start justify-between lg:justify-start gap-4 lg:gap-5 mb-5 md:mb-10 px-4 lg:px-0 w-full overflow-hidden">
                            <div className="flex flex-col items-start lg:flex-row lg:items-center lg:gap-5 min-w-0 max-w-[91%]">
                                <motion.h1
                                    initial={{ opacity: 0, x: -20 }}
                                    animate={{ opacity: 1, x: 0 }}
                                    transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
                                    className="text-[17px] md:text-3xl lg:text-5xl xl:text-6xl font-black leading-none text-white uppercase whitespace-normal lg:whitespace-nowrap truncate text-left"
                                >
                                    {movie.title}
                                </motion.h1>
